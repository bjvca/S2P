...
*Merging main and recomndation files 
	use "$processed/estimation_data_v1B", clear 
	duplicates tag Barcode , gen(dup)
	*list farmer_id Barcode if dup==1 // We now have 38 duplicates - it was 126. 
	*list farmer_id Barcode if dup>1 // This is now resolved - no missing barcodes
